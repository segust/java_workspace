            ...
            if (rs.next()) {
                ...
                while (rs.next()) {
                    ...
                    if (currenttime.getMonth() == lasttime.getMonth()) {
                        ...
                        if (holidayMap.get(String.valueOf((lasttime.getMonth() + 1) * 100 + lasttime.getDate())) == 2) {
                            if (!holidaypassMap.containsKey(lastlocation)) {
                                holidaypassMap.put(lastlocation, 1);
                            } else {
                                int n = holidaypassMap.get(lastlocation);
                        ...
                        if (rs.isLast()) {
                            ...
                            Collections.sort(list3, new Comparator<Entry<String, Integer>>() {
                                public int compare(Entry<String, Integer> o1, Entry<String, Integer> o2) {
                                    return (o2.getValue() - o1.getValue());
                                }
                            });
                            ...
                            Collections.sort(list4, new Comparator<Entry<String, Integer>>() {
                                public int compare(Entry<String, Integer> o1, Entry<String, Integer> o2) {
                                    return (o2.getValue() - o1.getValue());
                                }
                            });
                            ...
                            Collections.sort(list6, new Comparator<Entry<String, Integer>>() {
                                public int compare(Entry<String, Integer> o1, Entry<String, Integer> o2) {
                                    return (o2.getValue() - o1.getValue());
                                }
                            });
