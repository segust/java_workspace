...
public class loginFrame extends JFrame {
    ...
    public loginFrame() {
        ...
        JLabel label = new JLabel("ÕËºÅ£º");
        ...
        JButton logButton = new JButton("µÇÂ¼");
        logButton.setBounds(67, 174, 87, 23);
        logButton.addActionListener(arg0 -> {

            boolean suc = true;

            if (usernameField.getText().isEmpty()) {
                textField.setText("ÇëÊäÈëÓÃ»§Ãû£¡");
                suc = false;
            } else if (passwordField.getPassword().length == 0) {
                textField.setText("ÇëÊäÈëÃÜÂë£¡");
                suc = false;
            }
        ...
        JButton exitButton = new JButton("È¡Ïû");
